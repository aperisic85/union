...
const About = () => {
  return (
    <div className="page-content container about-content">
      <h1>O nama</h1>
      <p>
        Sindikat zaposlenika Plovput je organizacija koja predstavlja i brine o
        pravima i interesima svih zaposlenika u Plovputu. Naš cilj je poboljšati
        radne uvjete, zaštititi prava zaposlenika i osigurati bolju budućnost za
        sve članove.
      </p>
      <p>
      ...
      <p>
        Naš tim se sastoji od predanih i iskusnih ljudi koji su posvećeni našoj
        zajednici. Radimo u skladu s načelima solidarnosti, poštenja i
        profesionalnosti, kako bismo osigurali da svi zaposlenici imaju sigurno
        i podržavajuće radno okruženje.
      </p>
      <p>
